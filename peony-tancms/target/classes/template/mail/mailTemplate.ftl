...
<div style="background:#e7e7e7;">
  ...
  <DIV style=" FONT-SIZE: 12px; PADDING-BOTTOM: 0px; MARGIN: 0px; PADDING-TOP: 0px; FONT-FAMILY: '宋体'; TEXT-ALIGN: center; ">
    <table width="780" height="31" border="0" cellspacing="0" cellpadding="0" style="margin:0 auto;border:1px solid #24262c; border-bottom:none;">
      <tr>
        <td height="200"><table width="100%" height="200" border="0" cellpadding="0" cellspacing="0" style=" MARGIN: 0px auto; TEXT-ALIGN: left">
            <tr>
              <td height="108" valign="top" ><img src="http://rb.peonydata.com/report/img/wyfl_nl_033.jpg" height="200"></td>
            </tr>
          </table></td>
      </tr>
    </table>
