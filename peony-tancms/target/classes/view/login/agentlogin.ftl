...
<body class="denglu_body3" onLoad="checkCookie()">
...
<form id="loginForm">
  ...
  <div class="denglu_anniuw"><input name="提交" type="button" class="denglu_anniu1 color_bai tb" value="" id="subBtn"/><input name="重置" type="reset"  class="denglu_anniu2 color_bai tb" value="重置"/></div>
</form>
</div>
...
<img src="${request.getContextPath()}/images/img/mddsj_login3/ios_dl_ip.png" width="125" height="125" />ios
<div class="line_1">
</div><img src="${request.getContextPath()}/images/img/mddsj_login3/android_dl_ip.png" width="125" height="125" />android
</div>
</div>