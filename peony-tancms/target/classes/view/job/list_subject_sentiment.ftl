...
$(document).ready(function(){
		<#if error?has_content>$.jBox.tip("${error}", 'success',3000);</#if>
});
</script>
</head>
<body>
...
<div class="bg">
  ...
  <a href="${request.getContextPath()}/job/toListSubjectSentiment">&nbsp;就业情报&nbsp;</a>&gt;&nbsp;文章列表 </div>
</div>
<div class="bg">
  <div class="fl_br">
			  ...
			  <div class="title_h1">
			    <ul>
			      <li class="this" id="wenzhang"><span class="t_tit">文章列表</span></li>
			        ...
			        <th>
			          <select name="type" id="type" onchange="setPageNo('1')">
							...
							<#list webDictionaryList as webDictionary>
								<option value="${webDictionary.value}" <#if homePageType==webDictionary.value> selected="selected" </#if> >${webDictionary.name?default('&nbsp;')}</option>
							</#list>
					  </select>
			          ...
			          <a href="javascript:" class="tb2 color_bai tbfasongyouxiang" style="color:white;" onmouseover="this.style='color:black;'" onmouseout="this.style='color:white;'" onclick="toSendMail();"> 发送邮件</a>
			          <a href="javascript:" class="tb2 color_bai tbfasongyouxiang" style="color:white;" onmouseover="this.style='color:black;'" onmouseout="this.style='color:white;'" onclick="delete_SubjectPage()"> 删除</a>
			          </th>
			      </tr>
			      </table>
      			</div>
...
<script type="text/javascript" language="javascript" src="${request.getContextPath()}/js/job/list_subject_sentiment_tree.js"></script>
</body>
</html>
