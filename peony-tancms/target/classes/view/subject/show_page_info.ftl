...
<div class="wenzhangxiangxi_t">
	...
	<h2 class="color_huise">
		...
		<span class="color_hongse_n">
			<a href="${subjectPage.url}" target="_blank">查看原文</a>
		</span>
		</#if>
		<span class="color_hongse_n">
        	<a href="javascript:" onclick="showWebInfo('${subjectPage.url}')">查看网站信息</a>
        </span>
	</h2>
</div>
...
<script type="text/javascript" language="javascript">
	...
	function loadSubjectPage(id,groupseedid){
		...
		form.action = "${request.getContextPath()}/subject/loadSubjectPage";
		form.method="post";
		form.submit();
	}
