  ...
  <div class="shoucang_wx">
      <div class="baikuang">
        <div class="soucangjis_w">
          ...
          <#list briefreportList as briefreport>  
		    <span class="tb2" style="float:left">
            	<a href="javascript:" onclick="window.parent.setBriefreportId('${briefreport.briefreportId}','${briefreport.name}','${pageId}')">${briefreport.name}</a>
            </span>
          </#list>
		  </div>
        </div>
