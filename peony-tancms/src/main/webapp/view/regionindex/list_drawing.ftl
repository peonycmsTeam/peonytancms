...
<script src="${request.getContextPath()}/js/drawingsheng.js" type="text/javascript"></script>
...
var nt = !1;
      ...
      <div class="fl_left" id="fl_xn" >
        <div class="fl_left_in">
          ...
          <div class="sj_zs_l">
            <ul>
              <li class="this"><a href="${request.getContextPath()}/regionindex/listDrawing">省内舆情指数</a></li>
              <li><a href="${request.getContextPath()}/regionindex/listDrawings">全国舆情指数</a></li>
            </ul>
          </div>
...
.fl_xn{ position:fixed; top:0;}
                ...
                <span class="t_tit t_titbx"><a name="zhishu1" id="zhishu1"></a>省内舆情指数 </span> </div>
              <div class="kuang_in">
                <h1 class="h12_z color_hongse">省内指数排行</h1>
               <div class="list" id="listregionindex">
        	 <div style=" padding-top: 40px; text-align: center;">
                ...
                <h1 class="h12_z color_hongse">省内舆情分布图</h1>
               <div class="list" id="listshengdistribute">
                <div style=" padding-top: 40px; text-align: center;">
          		<div class="tuxing_dengdai"></div>
        			 <p>正在加载</p>
         	</div>
                ...
                <div class="linexsw_1"></div>
                <h1 class="h12_z color_hongse">省内热点事件TOP10 </h1>
                  <div class="list" id="listeventindexsheng">    
                   <div style=" padding-top: 40px; text-align: center;">
          		<div class="tuxing_dengdai"></div>
        			 <p>正在加载</p>
         	</div>     
...
$(document).ready(function() {
	...
	$('.zh_fx_table').find('tr:odd').addClass('zh_odd')
          ...
          <div class="baikuang">
            <div class="yq_zs_k">
              <div class="title_h1"> <span class="t_tit t_titbx">省内内舆情走势<a name="zhishu2" id="zhishu2"></a></span></div>
              <div class="kuang_in">
                <h1 class="h12_z color_hongse">省内舆情走势</h1>
               <div class="list" id="listtendency">    
                <div style=" padding-top: 40px; text-align: center;">
          		<div class="tuxing_dengdai"></div>
        			 <p>正在加载</p>
         	</div>	
                ...
                <div class="HackBox"></div>
                <div class="linexsw_1"></div>
                <h1 class="h12_z color_hongse">省内舆情增长率排行</h1>
               <div class="list" id="listgrowthrate">
                <div style=" padding-top: 40px; text-align: center;">
          		<div class="tuxing_dengdai"></div>
        			 <p>正在加载</p>
         	</div>
          ...
          <div class="baikuang">
            <div class="yq_zs_k">
               <div class="title_h1"> 
               	<span class="t_tit t_titbx">省内媒体占比<a name="zhishu3" id="zhishu3"></a></span></div>
              <div class="kuang_in">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top"><h1 class="h12_z color_hongse">媒体占比 </h1>
                      <div class="list" id="listmediacountsheng">
                       <div style=" padding-top: 40px; text-align: center;">
          		<div class="tuxing_dengdai"></div>
        			 <p>正在加载</p>
         	</div>
        </div></td>
                    <td><h1 class="h12_z color_hongse"><span class="on_right"> </span> </h1>
          ...
          <div class="baikuang">
            <div class="yq_zs_k">
              ...
              <div class="kuang_in">
                ...
                <div class="list" id="listIndustrycount">
                 <div style=" padding-top: 40px; text-align: center;">
          		<div class="tuxing_dengdai"></div>
        			 <p>正在加载</p>
         	</div>
                ...
                <h1 class="h12_z color_hongse">行业舆情分布图
                  TOP10 </h1>
                <div class="list" id="listdistributesheng">
                 <div style=" padding-top: 40px; text-align: center;">
          		<div class="tuxing_dengdai"></div>
        			 <p>正在加载</p>
         	</div>
