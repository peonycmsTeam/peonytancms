...
<div class="bg">
  ...
  <a href="${request.getContextPath()}/subject/toListOverseasSubjectSentiment">&nbsp;境外舆情&nbsp;</a>&gt;&nbsp;文章列表 </div>
</div>
<div class="bg">
  <div class="fl_br">
    <div class="fl_br_in">
			    ...
			    <table width="100%" border="0" cellpadding="0" cellspacing="0">
			      <tr>
			        ...
			        <th>
			          ...
			          <a style="color:white;" onmouseover="this.style='color:black;'" onmouseout="this.style='color:white;'" class="tb2 color_bai tbfasongyouxiang" href="javascript:" onclick="toSendMail();"> 发送邮件</a>
			          <a style="color:white;" onmouseover="this.style='color:black;'" onmouseout="this.style='color:white;'" class="tb2 color_bai tbfasongyouxiang" href="javascript:" onclick="delete_SubjectPage()"> 删除</a>
			          </th>
			      </tr>
			      </table>
      			</div>
...
<script type="text/javascript" language="javascript" src="${request.getContextPath()}/js/subject/list_subject_sentiment_tree_jw.js"></script>
</body>
</html>
