         ...
         <form   id="selecttime">
          ...
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <th>开始时间:</th>
              <td>
                 <input class="inputxsf" type="text" name="stime" id="stime" readonly="true"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" datatype="*" nullmsg="请选择开始时间"/>
              </td>
            </tr>
             <tr>
              <th>结束时间:</th>
              <td>
                  <input class="inputxsf" type="text" name="etime" id="etime" readonly="true"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" datatype="*" nullmsg="请选择结束时间"/>
              </td>
            </tr>
