        ...
        <div class="table_tanchu">
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td>
                <input value="${topic.title}" type="text" name="name" id="name" datatype="*" nullmsg="请填写标题"/></td>
            </tr>
            <tr>
              <th>摘要：
</th>
              <td><textarea style="height:100px; width:100%" name="abstruct" id="abstruct" >${topic.summary}</textarea></td>
            </tr>
            
            <tr>
              <th>地域关键词： </th>
              <td><textarea style="height:100px; width:100%" name="area" id="area"></textarea><div class="x_tishi1">关键词用空格隔开</div></td>
            </tr>
            <tr>
              <th>主体关键词： </th>
              <td><textarea style="height:100px; width:100%" name="mainKeywords" id="mainKeywords" ></textarea><div class="x_tishi1">关键词用空格隔开</div></td>
            </tr>
             <tr>
              <th>事件关键词： </th>
              <td><textarea style="height:100px; width:100%" name="deputyKeywords" id="deputyKeywords" ></textarea><div class="x_tishi1">关键词用空格隔开</div></td>
            </tr>
            <tr>
              <th>过滤关键词：
                </th>
              <td><textarea style="height:50px; width:100%" name="ruleoutKeywords" id="ruleoutKeywords" ></textarea><div class="x_tishi1">关键词用空格隔开</div></td>
            </tr>
