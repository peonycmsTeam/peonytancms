...
<script src="${request.getContextPath()}/js/topic/topic_add.js"></script>
<!--[if lte IE 6]>
        ...
        <div class="table_tanchu">
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td>
                <input type="text" name="name" id="name" datatype="*" nullmsg="请填写标题"/></td>
            </tr>
            <tr>
              <th>摘要：</th>
              <td><textarea style="height:50px; width:100%" name="abstruct" id="abstruct" ></textarea></td>
            </tr>
            
              <tr>
              <th>地域关键词： </th>
              <td><textarea style="height:100px; width:100%" name="area" id="area"></textarea><div class="x_tishi1">例：北京 上海;多个关键词请用空格隔开</div></td>
            </tr>
            <tr>
              <th>主体关键词： </th>
              <td><textarea style="height:100px; width:100%" name="mainKeywords" id="mainKeywords" ></textarea><div class="x_tishi1">例:义务教育(采集包含"义务教育"的信息);多个关键词用空格隔开</div></td>
            </tr>
             <tr>
              <th>事件关键词： </th>
              <td><textarea style="height:100px; width:100%" name="deputyKeywords" id="deputyKeywords" ></textarea><div class="x_tishi1">例:捐资助学 乱收费(采集包含"义务教育",并且包含"捐资助学"或"乱收费"的信息);多个关键词用空格隔开</div></td>
            </tr>
            <tr>
              <th>过滤关键词：
                </th>
              <td><textarea style="height:50px; width:100%" name="ruleoutKeywords" id="ruleoutKeywords" ></textarea><div class="x_tishi1">例:治理乱收费(满足上述条件，但是包含"治理乱收费"的信息除外);多个关键词用空格隔开</div></td>
            </tr>
